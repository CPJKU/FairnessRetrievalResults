...
if __name__ == "__main__":
    ...
    _retrivalresults = FaiRRMetric.read_retrievalresults_from_runfile(args.runfile)
    _background_doc_set = FaiRRMetric.read_documentset_from_retrievalresults(args.backgroundrunfile)
